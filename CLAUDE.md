...
15. **Grandmaster (Tier S) — Audit 2026-08-07, Round 1+2 เสร็จ 2026-08-07:** เนื้อเกมจริงต่อครบวงจรแล้ว (จัดไพ่ → ตัดสินผู้ชนะ → หักเงินจริง) รายละเอียด:
    ...
    - **ยังไม่ทำ (milestone ถัดไป):** ~~UI "เปิดไพ่ฝ่ายตรงข้ามตอน showdown"~~ ทำแล้วใน Round 5 ด้านล่าง · Sovereign (S+) ยังไม่มีหน้าจอโต๊ะเล่นจริง มีแค่ lobby (qualify/check-in/standby) — ดู pending เดิมเรื่องนี้แยกต่างหาก
