...
const matchWin = require('../../assets/audio/sfx/result/match_win.mp3')
...
const jackpotFanfare = require('../../assets/audio/commons/sfx_jackpot_fanfare.wav')
...
export const audioRegistry: Record<AudioEvent, AudioDefinition> = {
  ...
  [AudioEvent.TRIPLE_SWEEP_CELEBRATION]: def(jackpotFanfare, AudioCategory.RESULT, AudioPriority.VERY_HIGH, .72, { cooldownMs: 2500, duckBgm: .30 }),
  ...
  [AudioEvent.PERFECT_VICTORY_BGM]: def(storyVictory, AudioCategory.BGM, AudioPriority.LOW, .24, { loop: true, fadeInMs: 1200, fadeOutMs: 800 }),
