export type ArenaClientPhase =
  ...
  | 'AUCTION_FACE_UP' | 'AUCTION_BLIND' | 'FINAL_ARRANGE' | 'JOKER_DECLARE'
  | 'DISCARD' | 'FINAL_LOCK' | 'RESOLVE_PILE_1' | 'GF_PILE_2'
  | 'RESOLVE_PILE_2' | 'GF_PILE_3_ROUND_1' | 'GF_PILE_3_ROUND_2'
