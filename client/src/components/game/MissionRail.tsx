...
const s=StyleSheet.create({wrap:{position:'absolute',left:0,right:0,bottom:'100%',paddingBottom:4,zIndex:10},rail:{height:22,flexDirection:'row',alignItems:'center',gap:4,paddingHorizontal:5,borderRadius:6,borderWidth:1,borderColor:'#8f793d',backgroundColor:'rgba(5,26,17,.94)'},missed:{opacity:.65,borderColor:'#8c6565'},title:{color:'#ffe195',fontSize:9,fontWeight:'800',flexShrink:1},detail:{color:'#ffe195',fontSize:9,fontWeight:'700',flex:1,textAlign:'right'},markers:{flexDirection:'row',gap:3},marker:{color:'#e4d9b7',fontSize:12},index:{fontSize:7},success:{color:'#88f5ac'},failure:{color:'#ff9292'},provisional:{opacity:.5},intro:{position:'absolute',left:0,right:0,bottom:0,borderRadius:7,backgroundColor:'#092218',padding:7,alignItems:'center',borderWidth:1,borderColor:'#dcc276'},introTitle:{color:'#ffe195',fontSize:15,fontWeight:'900'},introText:{color:'#fff4ca',fontSize:10,textAlign:'center'}})
