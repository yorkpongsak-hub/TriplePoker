...
const PileColumn: React.FC<{
  ...
  // มุมพัด/ความโค้งตามจำนวนไพ่ (3 ใบ ≈ ±8°, 5 ใบ ≈ ±16°) — ใช้ร่วมกันทั้ง Free (ไม่ใช้จริง) และ VIP
  ...
  if (isVip) {
    ...
    // กวาดออกเป็นพัดเอง — คำนวณ bounding box ของพัดทั้งชุด (มุมกว้างสุดกำหนดขอบเขต เพราะ sin โตตามมุม
    // ในช่วง 0-16° เสมอ) ให้ container กว้าง/สูงพอดี ไม่ล้นเข้าไปทับกองข้างเคียงใน frame แถวเดียว
