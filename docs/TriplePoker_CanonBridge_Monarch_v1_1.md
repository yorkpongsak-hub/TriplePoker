# TriplePoker — Canon Bridge: Monarch as Herald (v1.1)

> **สถานะ:** Canon (narrative layer)
> **ขอบเขต:** เส้นเรื่องของ Monarch + การเชื่อมไตรภาค + บทพูด + responsible gaming messaging
> **คู่กับ:** `TriplePoker_Monarch_Spec_v2_1.md` (technical layer)
> **การเปลี่ยนแปลงจาก v1.0:** ปรับ narrative ให้เข้ากับ **1v1 model** (คู่เอก Human vs Herald + บริวาร 2 ตัวถอยตาม phase)
...
- ผู้เล่น Human = **challenger คนเดียว** ที่มีเดิมพันจริงกับ Monarch
- บริวาร 2 ตัว (Minion) ร่วมโต๊ะเป็น **สักขี** — สู้ Herald ได้แค่ยกแรก (G1) พอเกมลึกขึ้น (G2/G3) ก็ถอย เหลือแต่ challenger ตัวจริงที่กล้าสู้จนจบ
- เวทีค่อยๆ clear จาก 4 ขา → เหลือ **คู่เอก Human vs Herald ตัวต่อตัว** (narrative ไต่ระดับตาม phase)
...
> MVP ทำ **Single Encounter** จริง (1v1) แต่ Canon เก็บวิสัยทัศน์ Two-Encounter ไว้เต็ม (ไม่ทิ้ง แค่เลื่อนที่อยู่ไป Arena)
...
## Changelog
- **v1.1** — ปรับ narrative เข้ากับ 1v1 model (คู่เอก Human vs Herald + บริวาร 2 ตัวถอยตาม phase) · เพิ่ม §1 "โครงการประจันหน้า"
